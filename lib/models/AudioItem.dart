...
class AudioItem extends Select with EquatableMixin {
  String name;
  Duration duration;
  ...
  factory AudioItem.fromDB(Map<String, dynamic> map) {
    return new AudioItem(
      ...
      createAt:
          DateFormat("yyyy-MM-dd HH:mm:ss").parse(map[TableAudio.createAt]),
      updateAt:
          DateFormat("yyyy-MM-dd HH:mm:ss").parse(map[TableAudio.updateAt]),
