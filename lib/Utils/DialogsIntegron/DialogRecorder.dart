                            ...
                            InkWell(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color:
                                            buttons[0].borderColor ?? cBlack),
                                    color:
                                        buttons[0].background ?? cBackground),
                                child: Padding(
                            ...
                            InkWell(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color:
                                            buttons[1].borderColor ?? cBlack),
                                    color:
                                        buttons[1].background ?? cBackground),
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 30, vertical: 12),
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.all(Radius.circular(50)),
                              border: Border.all(
                                  color: buttons[0].borderColor ?? cBlack),
